...
<div id="wrapper">
        ...
        <div id="page-content" style="margin-left:-80px;">
         <div class="spacer_"></div> 
      <h2 style="margin-bottom:20px;">다른 유저에게 1:1 쪽지</h2>
      <hr>
<span class="text-muted" style="margin-left:10px;"><span class="label label-warning">Note:-</span>
다른 유저에게 1:1 쪽지가 가게됩니다. 모함성, 시비성 쪽지는 관리자 확인 후 제재될 수 있습니다.</span><br>
<div class="spacer_20"></div>

<form name="f" method="post" action="user_messagewrite">
	<input type="hidden" name="from" value="toindividual"/> 	
    ...
    <tr>
     ...
     <tr>
    	<td>받는이</td> 
    	<td><input type="text" name="message_receiverid" id="message_receiverid" size="80" value="${receiverid}" disabled/></td>
    </tr>
    <tr>
    	<td>쪽지제목</td> 
	...
	<tr>
			<td colspan="2" align="center">
				...
				<input type="button" class="btn btn-primary" value="보낸 쪽지함보기" onclick="window.location='user_messagesent'">
			</td>	
		</tr>
</table>
